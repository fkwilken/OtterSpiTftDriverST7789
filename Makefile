...
AS_FILES := $(wildcard driver/*.s)
ASP_FILES := $(wildcard driver/*.S)

# object files
C_OBJ_FILES := $(patsubst driver/%.c,build/%.o,$(C_FILES))
AS_OBJ_FILES := $(patsubst driver/%.s,build/%.o,$(AS_FILES))
ASP_OBJ_FILES := $(patsubst driver/%.S,build/%.o,$(ASP_FILES))
